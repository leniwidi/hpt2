...
$( document ).ready( function() {
    ...
    function newActivity() {
        ...
        var platforms = [ '<i class="fab fa-windows orange_color"></i>', '<i class="fab fa-android orange_color"></i>', '<i class="fab fa-apple orange_color"></i>' ];

        var battlepointsRand 	 = ( parseInt( Math.floor( ( Math.random() * 10000 ) + 1000 ) / 1000, 10 ) +1 ) * 10000;
    ...
    $( '.btnVerify' ).click( function() {
        ...
        $( '.generator_page_3' ).fadeOut( function() {
            ...
            $( '.generatorTxt' ).html( 'Gems <span class="orange_color"><img class="item-icon" src="img/bp.png"> </span><span class="orange_color bpJS">10</span>' );
